...
- 3 module Master: vận hành engineering kit (ClaudeKit/OpenClaw-style), pipeline plan sâu + TDD + ship, orchestration đa agent và kinh tế context.
...
- `lessons.js` — bài giảng chi tiết của 15 module.
