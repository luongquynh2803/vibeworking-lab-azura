...
Công cụ tự học **Agentic Vibe Working: Từ AI-Native Mindset đến xây dựng, kinh doanh và vận hành Agent Skills** — 20 module, web tĩnh chạy offline, không cần cài đặt.
...
- 8 module Master: vận hành engineering kit (ClaudeKit), pipeline plan sâu + TDD + ship, orchestration đa agent; Mobile Agent cho người non-tech (Telegram tự dựng, remote control và cloud agent chính thức); OpenClaw qua 4 module (cài đặt & vận hành, trí nhớ & persona, automation & coding harness, security & production).
- Điều kiện đầu vào theo từng chặng: Foundation, Advanced, Master.
...
- Rubric chấm đầu ra cho từng module và artifact mẫu để người học đối chiếu: context, workflow, skill, test matrix, capstone.

## Bài giảng

Mỗi module có tab **Bài giảng** với nội dung tự học đầy đủ (~1300-2200 từ, 9-19 phút đọc): giải thích khái niệm, ví dụ thực tế, prompt mẫu và hướng dẫn thực hành từng bước. Các module Advanced có thêm phần **Setup thực chiến** với Cowork/Claude Code CLI. Nội dung nằm trong `lessons.js`.
...
- **Rubric module**: mỗi module có rubric "đạt / xuất sắc" để tự chấm trước khi hoàn thành.
...
- **Artifact mẫu**: 5 mẫu đầu ra chuẩn giúp người học hình dung sản phẩm cuối của từng chặng.
...
- `lessons.js` — bài giảng chi tiết của 20 module.
