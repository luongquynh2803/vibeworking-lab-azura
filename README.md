...
- 5 module Master: vận hành engineering kit (ClaudeKit), pipeline plan sâu + TDD + ship, orchestration đa agent và kinh tế context; OpenClaw — trợ lý AI cá nhân tự vận hành (cơ bản + nâng cao).
...
- `lessons.js` — bài giảng chi tiết của 17 module.
